<h1>Welcome to schedule a call</h1>
...
<div class="min-h-screen bg-gray-100 py-6 flex flex-col justify-center sm:py-12">
    <div class="relative py-3 sm:max-w-xl sm:mx-auto">
      <div class="rounded border border-gray-300 px-6 py-4 my-4 w-full">
        <div class="flex items-center">
          <a class="flex h-12 w-12 mr-3" href="https://twitter.com/naval" target="_blank" rel="noopener noreferrer">
            <img alt="Naval" src="https://pbs.twimg.com/profile_images/1256841238298292232/ycqwaMI2_400x400.jpg" class="rounded-full" />
          </a>
          <a href="https://twitter.com/naval" class="author" target="_blank" rel="noopener noreferrer" class="flex flex-col ml-4">
            ...
            <span class="text-gray-500" title="{`@naval`}"> @naval </span>
          </a>
          <a class="ml-auto" href="https://twitter.com/naval" target="_blank" rel="noopener noreferrer">
        ...
        <div class="mt-4 mb-2 leading-normal whitespace-pre-wrap text-lg text-gray-700">Learn to sell. Learn to build. If you can do both, you will be unstoppable.</div>
        ...
        <div class="flex text-gray-700 mt-2">
          <a class="flex items-center mr-4 text-gray-500 hover:text-blue-600 transition hover:underline" href="#" target="_blank" rel="noopener noreferrer">
          ...
          <a class="flex items-center mr-4 text-gray-500 hover:text-green-600 transition hover:underline" href="#" target="_blank" rel="noopener noreferrer">
            <svg class="mr-2" width="24" height="24" viewBox="0 0 24 24">
          ...
          <a class="flex items-center text-gray-500 hover:text-red-600 transition hover:underline" href="#" target="_blank" rel="noopener noreferrer">
            <svg class="mr-2" width="24" height="24" viewBox="0 0 24 24">
