<header class="relative text-white h-screen bg-cover bg-center" style="background-image: url('{{ asset('resources/images/Hero image.png') }}');">
    ...
    <nav class="md:hidden">
        <div class="flex items-center justify-between h-20 px-6 md:px-10">
            ...
            <!-- Hamburger Button -->
            <button id="menuToggle" type="button" class="inline-flex items-center justify-center p-2 w-12 h-12 text-sm text-gray-500 rounded-lg hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600">
        ...
        <!-- Navbar Links -->
        <div id="navLinks" class="hidden flex-col text-base font-medium mt-4 rounded-lg bg-custom-gradient dark:bg-gray-800 dark:border-gray-700 p-4">
            <a href="#" class="block py-2 px-3 text-white bg-customPurple rounded dark:bg-purple-600" aria-current="page">Portfolio</a>
            <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Our Team</a>
            <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">About Us</a>
            ...
            <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Pricing</a>
            <a href="#" class="block py-2 px-3 text-gray-900 rounded hover:bg-gray-100 dark:text-gray-400 dark:hover:bg-gray-700 dark:hover:text-white">Contact Us</a>
        </div>
    </nav>

    <!-- Hero Section -->
    <div class="container mx-auto text-center py-12 px-4">
        <h1 class="text-5xl md:text-6xl font-light mb-4 lg:my-14" style="font-family: 'Inria Sans', sans-serif;">We Develop</h1>
