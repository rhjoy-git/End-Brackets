<header class="relative text-white h-dvh md:h-screen bg-cover bg-center"
    ...
    <nav class="md:hidden">
        <div class="flex items-center justify-between h-20 px-6 md:px-10">
            ...
            <button id="menuToggle" type="button"
                class="inline-flex items-center justify-center p-2 w-10 h-10 text-sm text-gray-500 rounded-lg hover:bg-[#2c0032] focus:outline-none focus:ring-2 focus:ring-purple-500 dark:text-gray-400 ">
        ...
        <!-- Navbar Links -->
        <div id="navLinks"
            class="hidden flex-col text-base font-medium mt-4 rounded-lg bg-[#2c0032] dark:bg-[#2c0032] p-4">
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white"
                aria-current="page">Portfolio</a>
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white">Our
                Team</a>
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white">About
                Us</a>
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white">Services</a>
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white">Pricing</a>
            <a href="#"
                class="block py-2 px-3 text-white rounded hover:bg-purple-600 dark:text-gray-400 dark:hover:bg-purple-600 dark:hover:text-white">Contact
                Us</a>
        </div>
    </nav>
    ...
    <div class="container mx-auto text-center py-12 px-4">
        <h1 class="text-3xl md:text-6xl font-light mt-3 mb-10 md:mb-4 lg:my-14"
            style="font-family: 'Inria Sans', sans-serif;">We Develop</h1>
        <h2 class="text-4xl md:text-7xl lg:text-8xl font-bold my-8 md:mb-6 lg:mb-16">Innovative Products</h2>
        ...
        <div class="flex justify-center space-x-2 md:space-x-4 mt-6">
            <!-- Portfolio Button -->
            <a href="portfolio"
                class="bg-purple-600 hover:bg-purple-700 text-white py-2 px-6 rounded-lg text-lg flex items-center space-x-2">
                <span>Portfolio</span>
